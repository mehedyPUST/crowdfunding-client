        ...
        <section className="py-16 md:py-20 bg-white">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    <h2 className="text-3xl md:text-4xl font-bold text-slate-800 mb-3">What Our Users Say</h2>
                    <p className="text-slate-500 max-w-2xl mx-auto">Real stories from creators and supporters.</p>
                </div>

                <Swiper modules={[Autoplay, Pagination]} autoplay={{ delay: 3500, disableOnInteraction: false }} pagination={{ clickable: true }} loop={true} spaceBetween={30} slidesPerView={1} className="pb-12">
                            ...
                            <div className="bg-slate-50 rounded-2xl p-8 md:p-10 border border-slate-200">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <div className="ml-auto flex gap-0.5">
                                        {[...Array(item.rating)].map((_, i) => <Star key={i} className="w-4 h-4 text-yellow-400 fill-yellow-400" />)}
                                    </div>
                                </div>
                                <blockquote className="text-slate-600 text-lg italic leading-relaxed">&ldquo;{item.quote}&rdquo;</blockquote>
                            </div>
                        </SwiperSlide>
                    ))}
                </Swiper>
