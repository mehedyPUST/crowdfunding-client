...
const slides = [
    {
        title: 'Fund Your Dream Project',
        subtitle: 'Join thousands of creators who turned their ideas into reality with community support.',
        bg: 'from-brand-700 via-brand-600 to-accent-700',
    },
    {
        title: 'Support What Matters',
        subtitle: 'Discover innovative campaigns and back the projects that inspire you.',
        bg: 'from-accent-800 via-accent-600 to-brand-700',
    },
    {
        title: 'Together We Rise',
        subtitle: 'Every contribution, no matter how small, helps bring creative visions to life.',
        bg: 'from-gray-900 via-brand-800 to-accent-800',
    },
];
                        ...
                        <div className={`h-full w-full bg-gradient-to-r ${slide.bg} flex items-center justify-center px-4`}>
                            <div className="text-center text-white max-w-3xl">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                    <Link
                                        href="/explore"
                                        className="inline-flex items-center gap-2 bg-white text-brand-700 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition"
                                    >
