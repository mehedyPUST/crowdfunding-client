...
import { Heart, Eye, EyeOff, Mail, Lock, LogIn, Sparkles, ArrowRight } from 'lucide-react';
            ...
            >
                ...
                <div className="hidden md:flex bg-gradient-to-br from-amber-500 via-orange-500 to-amber-600 p-10 flex-col justify-center items-center text-white relative overflow-hidden">
                    ...
                    <motion.p
                        ...
                        className="text-center text-amber-100 text-sm sm:text-base leading-relaxed mb-8"
                    >
                    ...
                    >
                        {[
                            ...
                            >
                                <div className="w-2 h-2 bg-amber-300 rounded-full flex-shrink-0" />
                ...
                <div className="p-8 sm:p-10 md:p-12">
                    ...
                    >
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    autoComplete="email"
                                    className="w-full pl-11 sm:pl-12 pr-4 py-3 sm:py-3.5 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition-all text-sm sm:text-base placeholder-gray-400"
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-11 sm:pl-12 pr-12 py-3 sm:py-3.5 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 outline-none transition-all text-sm sm:text-base placeholder-gray-400"
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.98 }}
                            className="w-full bg-gradient-to-r from-amber-500 to-orange-500 text-white py-3.5 sm:py-4 rounded-2xl font-bold text-sm sm:text-base hover:from-amber-600 hover:to-orange-600 transition-all disabled:opacity-50 flex items-center justify-center gap-2 shadow-md shadow-amber-200"
                        >
                            {loading ? (
